<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentEdit.aspx.cs" Inherits="LibraryManagementSystem.StudentEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container py-5">
        <div class="row">
            <div class="col-6">
                <h3 class="h3 text-white">Edit Student</h3>
            </div>
                ...
                <div class="card p-3">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Required" ControlToValidate="StudentId" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="form-group mt-3">
                            <asp:Button CssClass="btn btn-dark" ID="UpdateStudentButton" runat="server" Text="Update Student" OnClick="UpdateStudentButton_Click" />
                        </div>
                    </div>
                </div>
            </div>
